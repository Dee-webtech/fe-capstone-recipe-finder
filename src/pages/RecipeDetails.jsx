...
export default function RecipeDetails() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <Link to="/home" className="text-blue-600 hover:underline mb-4 block">&larr; Back to recipes</Link>
      <h2 className="text-3xl font-bold mb-4">{recipe.strMeal}</h2>
      <img src={recipe.strMealThumb} alt={recipe.strMeal} className="rounded-lg mb-6" />
      ...
      <ul className="list-disc list-inside mb-6">
        {Array.from({ length: 20 }).map((_, i) => {
          ...
          return ingredient && <li key={i}>{ingredient} - {measure}</li>;
        })}
      </ul>
